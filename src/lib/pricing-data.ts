...
export const shiteikoSetPlans: PricingRow[] = [
  {
    title: "全講座セット",
    price: "328,000円",
    notes: "90分×36コマ ／ 単科合計388,000円から60,000円お得"
  },
  {
    title: "面接＋医療時事",
    price: "168,000円",
    notes: "90分×20コマ ／ 単科合計192,000円から24,000円お得"
  },
  {
    title: "学科＋小論文",
    price: "178,000円",
    notes: "90分×16コマ ／ 単科合計196,000円から18,000円お得"
  }
];
...
export const shiteikoFees = {
  ...
  comparisonNote:
    "参考: 単科で全科目を受講した場合の合計は388,000円。全講座セットは328,000円で、60,000円分のセット優待が適用されます。先着5名限定で、不合格の場合は全額返金キャンペーンを実施中（残り3名）。"
} as const;
